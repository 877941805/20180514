...
#==============================================================================
                ...
                for g in the_guys:
                    to_sock = self.logged_name2sock[g]
                    mysend(to_sock, json.dumps({"action":"exchange", "message":msg["message"], "from":'['+from_name+']'}))
#==============================================================================
...
#==============================================================================
                ...
                poem = self.sonnet.get_sect(int(msg["target"]))
                print('here:\n', poem)
...
#==============================================================================
                ...
                for i in self.indices.keys():
                    search_rslt += self.indices[i].search(wd)
